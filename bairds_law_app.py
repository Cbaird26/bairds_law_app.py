...
sections = ["Introduction", "Core Equation", "Key Components", "Mathematical Formulation", "Conclusion"]
...
# Core Equation
if selected_section == "Core Equation":
    st.write("""
    ## Core Equation
    The core equation representing this unification is the action for the Theory of Everything (ToE):
    """)
    st.latex(r"""
...
# Key Components
if selected_section == "Key Components":
    st.write("""
    ## Key Components
...
if selected_section == "Mathematical Formulation":
    st.write("""
    ## Mathematical Formulation
    ### Action Integral
...
# Conclusion
if selected_section == "Conclusion":
    st.write("""
    ## Conclusion
